...
class InfoseekMasterModel(models.Model):
...
class InfoseekVerificationModel(models.Model):
    ...
    following_information_providedby = models.CharField(max_length=50, choices=Basic_Information_ENUM) 
    ...
    BloodGroup =models.CharField(max_length=50, choices=BloodGroup_ENUM)
    Rh_Factor = models.CharField(max_length=50, choices=Rh_Factor_ENUM)
    ...
    Mothers_Ethnicity = models.CharField(max_length=200, choices=Ethnicity_ENUM)
    ...
    Fathers_Ethnicity = models.CharField(max_length=200, choices=Ethnicity_ENUM)
    ...
    Do_you_have_health_insurance = models.CharField(max_length=100, choices=SRNYesorNo) 
    ...
    Belongs_To = models.CharField(max_length=100, choices=Belongs_To_ENUM, null=True,blank=True)
    Email_Registered_With_School = models.EmailField()
    

    # D. Emergency Contact
    Primary_Contact = models.BigIntegerField(null=True, blank=True)
    Primary_Contact_Belongs_To = models.CharField(max_length=100, choices=Basic_Information_ENUM,null=True,blank=True) 
    ...
    Secondary_Contact_Belongs_To = models.CharField(max_length=100, choices=Basic_Information_ENUM,null=True,blank=True)
    ...
    What_typeof_recreational_activity_doesthestudentenjoy = models.CharField(max_length=100, choices=Basic_Lifestyle_ENUM,null=True,blank=True)
    ...
    Isthe_student_memberofasports_teamatschool = models.CharField(max_length=100, choices=SRNYesorNo,null=True,blank=True)
    Isthe_student_memberofasports_teamatschool_Yes = models.CharField(max_length=100, null=True, blank=True)
    Do_you_have_pets_at_home = models.CharField(max_length=100, choices=SRNYesorNo,null=True,blank=True)
    ...
    Type_of_meal = models.CharField(max_length=1000, choices=Type_of_meal_ENUM,null=True,blank=True)
    Type_of_meal_Other = models.CharField(max_length=10000, null=True, blank=True)
    Does_the_student_have_breakfast_regularly = models.CharField(max_length=100, choices=SRNYesorNo,null=True,blank=True)
    Does_the_student_have_regular_meal_at_school = models.CharField(max_length=100, choices=SRNYesorNo,null=True,blank=True)
    Student_If_Yes_where_does_it_come_from = models.CharField(max_length=100, choices=StudentMeal_If_Yes_ENUM,null=True,blank=True)
    ...
    Does_the_student_have_any_sleep_related_issues = models.CharField(max_length=1000,choices=SRNYesorNo, null=True, blank=True) 
    ...
    What_is_the_students_average_length_of_sleep_per_night = models.CharField(max_length=100, choices=Students_average_sleep_ENUM,null=True,blank=True) 
    What_is_the_students_nap_cycle_during_day_Nap = models.CharField(max_length=10000, null=True, blank=True)

    def save(self, *args, **kwargs):
        # Convert the comma-separated string to a list before saving
        if self.What_is_the_students_nap_cycle_during_day_Nap:
            self.What_is_the_students_nap_cycle_during_day_Nap = [item.strip() for item in self.What_is_the_students_nap_cycle_during_day_Nap.split(',')]

            # Now, convert the list to a dictionary
            nap_dict = {}
            for i, value in enumerate(self.What_is_the_students_nap_cycle_during_day_Nap, start=1):
                key = f'nap{i}'
                nap_dict[key] = value

            # Serialize the dictionary back to a string and save it
            nap_string = str(nap_dict)
            self.What_is_the_students_nap_cycle_during_day_Nap = nap_string

        super(InfoseekVerificationModel, self).save(*args, **kwargs)
 


    # H. Personality and Social Interaction

    How_would_you_describe_the_social_personality_ofthe_student = models.CharField(max_length=1000, choices=Social_personality_student_ENUM,null=True,blank=True) 
    ...
    How_would_you_rate_the_students_self_image_self_worth = models.CharField(max_length=100, choices=Students_self_image_ENUM,null=True,blank=True)
    ...
    How_would_you_best_describe_the_student_reaction_to_change = models.CharField(max_length=100, choices=Student_reactions_change_ENUM,null=True,blank=True) 
    Student_reaction_Other = models.CharField(max_length=10000, null=True, blank=True)
    How_would_you_describe_student_rs_with_other_students = models.CharField(max_length=100, choices=Student_reaction_change_others_ENUM,null=True,blank=True) 
    How_would_you_describe_student_rs_with_other_students_Other = models.CharField(max_length=10000,null=True,blank=True)
    Does_the_student_have_any_significantly_close_friends = models.CharField(max_length=100, choices=SRNYesorNo,null=True,blank=True) 
    ...
    What_is_student_general_opinion_of_school = models.CharField(max_length=100, choices=Student_general_opinion_ENUM,null=True,blank=True) 
    The_student_goes_to_school = models.CharField(max_length=100, choices=SRNYesorNo,null=True,blank=True) 
    ...
    Does_the_student_have_any_medicalissue_In_The_Past = models.CharField(max_length=1000, choices=SRNYesorNo, null=True, blank=True)
    Does_the_student_have_any_medicalissue_In_The_Past_Yes = models.CharField(max_length=1000, null=True, blank=True) 
    Does_the_student_have_any_medicalissue_Currently = models.CharField(max_length=1000, choices=SRNYesorNo, null=True, blank=True) 
    ...
    def save(self, *args, **kwargs):
            if not self.pk:
                latest_InfoseekId = InfoseekVerificationModel.objects.order_by('-InfoseekId').first()
                if latest_InfoseekId:
                    self.InfoseekId = latest_InfoseekId.InfoseekId + 1
                else:
                    self.InfoseekId = 1
...
class NoteModel(models.Model):
    InfoseekId = models.ForeignKey('InfoseekVerificationModel',related_name='Note_Infoseek',on_delete=models.CASCADE)
    Last_date_signed_copy_of_form = models.CharField(max_length=100,null=True,blank=True)
    type_your_name = models.CharField(max_length=100,null=True,blank=True)
    gaurdian_of = models.CharField(max_length=100,null=True,blank=True)
    of_class = models.CharField(max_length=100,null=True,blank=True)
    Signature =  models.CharField(max_length=100, choices=Belongs_To_ENUM, null=True,blank=True)
    Submitted_date = models.CharField(max_length=100,null=True,blank=True)
    place = models.CharField(max_length=100,null=True,blank=True)
    upload_sign = models.ImageField(upload_to='Infoseek',null=True, blank=True,max_length=100000)
...
class OtpModel(models.Model):
    ...
    class Meta:
        db_table = 'infoseek_OTP'
        
class InfoseekFileUploadModels(models.Model):
     file = models.FileField()


class ImmunizationModel(models.Model):
     ImmunizationId = models.IntegerField(primary_key=True)
     Vaccine = models.CharField(max_length=500)
     Vaccine_Code = models.CharField(max_length=500)
     Vaccine_Shortname = models.CharField(max_length=500)
     Vaccine_Description = models.CharField(max_length=500)
     Area = models.CharField(max_length=500)
     Source_Comments = models.CharField(max_length=500,null=True,blank=True)
     ...
     def save(self, *args, **kwargs):
            if not self.pk:
                latest_ImmunizationId = ImmunizationModel.objects.order_by('-ImmunizationId').first()
                if latest_ImmunizationId:
                    self.ImmunizationId = latest_ImmunizationId.ImmunizationId + 1
                else:
                    self.ImmunizationId = 1
            return super().save(*args, **kwargs)

     class Meta:
        db_table = 'Immunization_Master'
...
class StateMasterModel(models.Model):
    CountryID = models.ForeignKey('CountryMasterModel',related_name='country',on_delete=models.CASCADE)
...
class CityMasterModel(models.Model):
    StateID = models.ForeignKey('StateMasterModel',related_name='state',on_delete=models.CASCADE)
...
class ImageUpload(models.Model):
    Image = models.ImageField(upload_to='Infoseek',max_length=100000)
    
    class Meta:
            db_table = 'Infoseek_image'
